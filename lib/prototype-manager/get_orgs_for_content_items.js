...
const csvFile = fs.readFileSync(path.resolve(__dirname, './data/raw_data_dump_with_base_paths.csv'), { 'encoding': 'utf8' });
...
function makeResponseHandler (basePath) {
  return function (jsonData) {
    ...
    if (basePathIdx < idToBasePathMap.length) {
      ...
      fs.writeFileSync(path.resolve(__dirname, './data/orgs_for_content_item_data_2017_05_29-2018_05_29.json'), JSON.stringify(idToOrg, undefined, 2), { 'encoding': 'utf8' });
