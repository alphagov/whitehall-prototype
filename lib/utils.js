...
exports.autoStoreData = function (req, res, next) {
  if (!req.session.data) {
    req.session.data = {
      ...
      'new-history': [],
      'new-lead-organisation': 'Ministry of Defence',

      'draft-title': 'Draft title',
      'draft-summary': 'Draft summary',
      'draft-body': 'Draft body',
      'draft-state': 'Draft',
      'draft-edition': '2nd edition',
      'draft-history': [],
      'draft-lead-organisation': 'Ministry of Defence',
      ...
      'submitted-history': [],
      'submitted-lead-organisation': 'Ministry of Defence',
      ...
      'published-history': [],
      'published-lead-organisation': 'Ministry of Defence'
    }
  }
